...
import { ILoadedEventArgs, Series, ChartTheme, ChartComponent }
...
@Component({
    ...
    template:
            `<ejs-chart #chart id='chart-container' [chartArea]='chartArea' [width]='width' align='center'
            [primaryXAxis]='primaryXAxis' [primaryYAxis]='primaryYAxis' [title]='title' (loaded)='loaded($event)'>
        <e-series-collection>
        ...
        this.intervalId = setInterval(
            () => {
                ...
                if (getElement('chart-container') === null) {
                    ...
                    this.series1.shift();
                    //this.series1=websocket.getData();
